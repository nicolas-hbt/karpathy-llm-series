...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        # advantage is that we only have to do one matrix multiply instead of three
        ...
        # but we concatenate them along the output dimension
        # output projection. Necessary to recombine the multiple heads, 
